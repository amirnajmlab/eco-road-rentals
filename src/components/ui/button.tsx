  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-car-green text-white hover:bg-car-yellow hover:text-car-gray border-2 border-transparent hover:border-car-green hover:shadow-2xl hover:scale-105 font-semibold animate-glow",
        glass: "glass backdrop-blur-md text-car-gray border border-white/20 hover:bg-white/90 hover:shadow-xl hover:scale-105",
        accent: "bg-car-yellow text-car-gray hover:bg-car-yellow-light hover:shadow-lg hover:scale-105 font-semibold",
      },
      size: {
